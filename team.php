...
<!-- Mirrored from demo.w3layouts.com/demosWTR/Freedom/30-03-2020/home-service-freedom-demo_Free/1435018137/web/team.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 12 Mar 2022 16:18:48 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
    <title>Home Service a Home Maintenance category Responsive Web Template | Team : W3layouts</title>
    ...
    <section class="w3l-teams-32-main">
        <div class="teams-32">
            <div class="wrapper">
                ...
                <h3 class="heading">Our expert Team</h3>
                <div class="d-grid grid-col-4 align-center main-contteam-32">
                    <div class="team-main-19">
                        <div class="column-19">
                            <a href="team-single.html"><img class="image-fluid img-responsive"
                                    src="assets/images/team1.jpg" alt=" "></a>
                        </div>
                        <div class="right-team-9">
                            <h6><a href="team-single.html" class="title-team-32">Johnson smith</a></h6>
                            <p class="sm-text-32">Electrician</p>
                    ...
                    <div class="team-main-19">
                        <div class="column-19">
                            <a href="team-single.html"><img class="image-fluid img-responsive"
                                    src="assets/images/team2.jpg" alt=" "></a>
                        </div>
                        <div class="right-team-9">
                            <h6><a href="team-single.html" class="title-team-32">Elizabeth Ker</a></h6>
                            <p class="sm-text-32">Plumber</p>
                            <div class="buttons-teams">
                                <a href="#team" class="facebook"><span class="fa fa-facebook"></span></a>
                                <a href="#team" class="twitter"><span class="fa fa-twitter"></span></a>
                                <a href="#team" class="linkedin"><span class="fa fa-linkedin"></span></a>
                    ...
                    <div class="team-main-19">
                        <div class="column-19">
                            <a href="team-single.html"><img class="image-fluid img-responsive"
                                    src="assets/images/team3.jpg" alt=" "></a>
                        </div>
                        <div class="right-team-9">
                            <h6><a href="team-single.html" class="title-team-32">Antony Wilson</a></h6>
                            <p class="sm-text-32">Worker</p>
                            <div class="buttons-teams">
                                <a href="#team" class="facebook"><span class="fa fa-facebook"></span></a>
                                <a href="#team" class="twitter"><span class="fa fa-twitter"></span></a>
                                <a href="#team" class="linkedin"><span class="fa fa-linkedin"></span></a>
                    ...
                    <div class="team-main-19">
                        <div class="column-19">
                            <a href="team-single.html"><img class="image-fluid img-responsive"
                                    src="assets/images/team4.jpg" alt=" "></a>
                        </div>
                        <div class="right-team-9">
                            <h6><a href="team-single.html" class="title-team-32">Laura Paul</a></h6>
                            <p class="sm-text-32">House cleaner</p>
                            <div class="buttons-teams">
                                <a href="#team" class="facebook"><span class="fa fa-facebook"></span></a>
                                <a href="#team" class="twitter"><span class="fa fa-twitter"></span></a>
                                <a href="#team" class="linkedin"><span class="fa fa-linkedin"></span></a>
                    ...
                    <div class="team-main-19">
                        <div class="column-19">
                            <a href="team-single.html"><img class="image-fluid img-responsive"
                                    src="assets/images/team5.jpg" alt=" "></a>
                        </div>
                        <div class="right-team-9">
                            <h6><a href="team-single.html" class="title-team-32">Alexander Sen</a></h6>
                            <p class="sm-text-32">Team worker</p>
                            <div class="buttons-teams">
                                <a href="#team" class="facebook"><span class="fa fa-facebook"></span></a>
                                <a href="#team" class="twitter"><span class="fa fa-twitter"></span></a>
                                <a href="#team" class="linkedin"><span class="fa fa-linkedin"></span></a>
                    ...
                    <div class="team-main-19">
                        ...
                        <div class="right-team-9">
                            <h6><a href="team-single.html" class="title-team-32">Brown kevin</a></h6>
                            <p class="sm-text-32">Team worker</p>
                            <div class="buttons-teams">
                                <a href="#team" class="facebook"><span class="fa fa-facebook"></span></a>
                                <a href="#team" class="twitter"><span class="fa fa-twitter"></span></a>
                    ...
                    <div class="team-main-19">
                        ...
                        <div class="right-team-9">
                            <h6><a href="team-single.html" class="title-team-32">Elexa kaur</a></h6>
                            <p class="sm-text-32">Team worker</p>
                            <div class="buttons-teams">
                                <a href="#team" class="facebook"><span class="fa fa-facebook"></span></a>
                                <a href="#team" class="twitter"><span class="fa fa-twitter"></span></a>
                    ...
                    <div class="team-main-19">
                        ...
                        <div class="right-team-9">
                            <h6><a href="team-single.html" class="title-team-32">Peterson</a></h6>
                            <p class="sm-text-32">Team worker</p>
                            <div class="buttons-teams">
                                <a href="#team" class="facebook"><span class="fa fa-facebook"></span></a>
                                <a href="#team" class="twitter"><span class="fa fa-twitter"></span></a>
...
<!-- Mirrored from demo.w3layouts.com/demosWTR/Freedom/30-03-2020/home-service-freedom-demo_Free/1435018137/web/team.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 12 Mar 2022 16:19:23 GMT -->
</html>