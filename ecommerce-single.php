            ...
            <div class="wrapper">
                <div class="features-photo-7_top">
                    <div class="features-photo-7_top-left">
                        <h4>Elegant Interior Furniture chair with 1 Extra table (46 cm x 26 cm x 23 cm, Pink) </h4>
                        ...
                        <p>A longer and sturdy puller handle helps to carry the bucket with ease from one place to
                            another </p>
                        <p>Micro fibre refill with super absorbent capacity </p>
                        <div class="feat_top">
                        ...
                        <div class="buttons">
                            <a href="ecommerce-cart.html" class="add">Add to cart</a>
